...
if IS_TRAIN:
    ...
    for i_episode in range(args.slots):
        ...
        for i_step in range(n_step_per_episode):
            ...
            #2 RSU 情况下代码
            train_reward, global_reward, train_hit_radio, train_cost = env.act_for_training(action_temp, state_old_all, test_dataset1, test_dataset2)
        ...
        if plot_i % 100 == 0:
            ...
            plt.legend(["global reward","RSU1 reward","RSU2 reward"])
            plt.show()
