...
from local_update import cache_hit1
...
class Environ:
    ...
    def Compute_Performance_Reward_Train(self, actions, state_old_all, test_dataset1):
        # RSU1
        ...
        #RSU1内容传递
        request_number1, hit_number1 = cache_hit1(test_dataset1, cache_content1)

        return replace_elements1, request_number1, hit_number1


    def act_for_training(self, actions, state_old_all, test_dataset1):
        ...
        replace_element1, request_number1, hit_number1 = self.Compute_Performance_Reward_Train(action_temp, state_old_all, test_dataset1)
        per_user_reward[0] = (self.c_cost - self.l_cost) * hit_number1 - self.r_cost * replace_element1

        per_user_hit_radio[0] = (hit_number1) / request_number1 * 100
        per_user_cost[0] = self.l_cost * hit_number1 + self.c_cost * (request_number1 - hit_number1) + \
