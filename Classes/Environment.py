...
class Environ:
    ...
    def Compute_Performance_Reward_Train(self, actions, state_old_all, test_dataset1, test_dataset2):
        # 2 RSU
        ...
        # RSU2内容传递
        request_number2, hit_number2, hit_number_n2 = cache_hit(test_dataset2, cache_content2, cache_content1)

        return replace_elements1, replace_elements2, request_number1, hit_number1, hit_number_n1, request_number2, hit_number2, hit_number_n2


    def act_for_training(self, actions, state_old_all, test_dataset1, test_dataset2):
        ...
        replace_element1, replace_element2, request_number1, hit_number1, hit_number_n1, request_number2, hit_number2, hit_number_n2 \
            = self.Compute_Performance_Reward_Train(action_temp, state_old_all, test_dataset1, test_dataset2)
